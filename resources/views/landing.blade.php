            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mt-6">
                    <div class="flex items-center">
                        ...
                        <label 
                            for="aggrement" 
                            class="text-gray-600 ml-3 cursor-pointer">He leido y acepto los 
                            <div class="flex items-center">
                                <input type="checkbox" name="aggrement" id="aggrement"
                                    class="text-primary focus:ring-0 rounded-sm cursor-pointer">
                                <label for="aggrement" class="text-gray-600 ml-3 cursor-pointer">He leído y acepto los <a
                                        href="#" class="text-primary">terminos y condiciones</a></label>
                            </div>
                        </label>
                    </div>
                </div>
